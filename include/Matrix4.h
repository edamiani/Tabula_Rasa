#ifndef __TR_MATRIX4__
#define __TR_MATRIX4__
...
namespace TR
{
    /** Class encapsulating a standard 4x4 homogenous matrix.
        @remarks
            TR uses column vectors when applying matrix multiplications,
        ...
        @par
            TR deals with the differences between D3D and OpenGL etc.
            internally when operating through different render systems. TR
            users only need to conform to standard maths conventions, i.e.
            right-to-left matrix multiplication, (TR transposes matrices it
